...
<div class="mainbg">
	<div class="left fleft">
		...
		<div class="weizhi">当前位置：<a href="#">首页</a> &gt; 公证表格</div>
		<!-- 公证表格 -->
		<div class="gzbglist">
			<ul>
				<li class="name"><a href="#">公证申请表</a></li><li class="xz"><a href="#"><img src="img/xz.jpg" /></a></li>
				<li class="name"><a href="#">公证证明表</a></li><li class="xz"><a href="#"><img src="img/xz.jpg" /></a></li>
				<li class="name"><a href="#">继承权证明表</a></li><li class="xz"><a href="#"><img src="img/xz.jpg" /></a></li>
				<li class="name"><a href="#">申办学历公证的证明</a></li><li class="xz"><a href="#"><img src="img/xz.jpg" /></a></li>
				<li class="name"><a href="#">经济事项公证申请表</a></li><li class="xz"><a href="#"><img src="img/xz.jpg" /></a></li>
				<li class="name"><a href="#">公证申请表</a></li><li class="xz"><a href="#"><img src="img/xz.jpg" /></a></li>
				<li class="name"><a href="#">公证证明表</a></li><li class="xz"><a href="#"><img src="img/xz.jpg" /></a></li>
				<li class="name"><a href="#">继承权证明表</a></li><li class="xz"><a href="#"><img src="img/xz.jpg" /></a></li>
				<li class="name"><a href="#">申办学历公证的证明</a></li><li class="xz"><a href="#"><img src="img/xz.jpg" /></a></li>
