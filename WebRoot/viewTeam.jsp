...
<div class="mainbg">
	<div class="left fleft">
		...
		<div class="weizhi">当前位置：<a href="#">首页</a> &gt; 公证团队</div>
		<!-- 业务范围 -->
		<div class="ywfw">

		   
				  <div class="ywshow" align="center">
				    ...
				    <table width="250" border="0" align="center" cellpadding="0" cellspacing="1">
					 ...
					 <tr>
                        <td colspan="2" align="center"><span class="name"><img src="${team.pic}"  width="140"  height="150"   /></span></td>
                      </tr>
                      <tr>
                        <td align="right"><span class="STYLE1">姓名：</span></td>
                        <td><span class="name STYLE3"><strong>${team.tname}</strong></span></td>
                      </tr>
                      <tr>
                        <td align="right"><span class="xinxi STYLE3"><strong>职位：</strong></span></td>
                        <td><span class="xinxi STYLE3"><strong>${team.position}</strong></span></td>
                      </tr>
                      <tr>
                        <td align="right"><span class="xinxi STYLE3"><strong>分管工作：</strong></span></td>
                        <td><span class="xinxi STYLE3"><strong>${team.workinfo}</strong></span></td>
                      </tr>
                    </table>
