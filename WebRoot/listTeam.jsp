...
pageContext.setAttribute("pageModel",dao.findByPage(Integer.parseInt(nowpage) ));
%>
		...
		<div class="ywfw">
		    ...
		    <ul><li></li>
				  ...
				  <div class="ywshow">
					...
					<c:forEach  items="${pageModel.list}"   var="team"  varStatus="vs" >
					
						<li>  <a href="viewTeam.jsp?tid=${team.tid}" >    <img src="${team.pic}"  width="140"  height="150"   />  </a>     </li>
						
						${(vs.index+1)%4==0?"</ul><ul>":""}  <!--vs.index索引号+1表示列号，如果是4列就换行   -->
					</c:forEach>	
						</ul>
