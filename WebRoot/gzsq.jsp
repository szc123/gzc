...
<div class="mainbg">
	<div class="left fleft">
		...
		<div class="weizhi">当前位置：<a href="#">首页</a> &gt; 公证申请</div>
		<!-- 公证申请 -->
		<div class="gzsq">
			<p class="name">公证申请</p>
			<table class="gztab" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<td class="name">姓名：</td>
					<td><input name="" /></td>
				</tr>
				...
				<tr>
					<td class="name">要求信息：</td>
					<td><textarea cols="" rows=""></textarea></td>
				</tr>
			</table>
			<div class="button"><button>提交</button> &nbsp; &nbsp;<button>取消</button></div>
		</div>
	</div>
