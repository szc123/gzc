...
<div class="mainbg">
	<div class="left fleft">
		...
		<div class="weizhi">当前位置：<a href="#">首页</a> &gt; 联系我们</div>
		<!-- 联系我们 -->
		<div class="lxwm">
			<p class="name"><b>湖北省武汉市楚信公证处（原湖北省公证处）</b></p>
			<p>・地    址：湖北省武汉市武昌区水果湖广场B座3楼<br />
・咨询电话：027-87363962  87304006  87831068<br />
・传    真：027-87304369<br />
・投诉电话：027-87233500</p>
			<p class="mapshow"><img src="img/map2.jpg" /></p>
			<p>公交车可以乘坐<span>14、108、411、552、709、701、578</span>路公共汽车或者1路电车到水果湖站下车</p>
		</div>
	</div>
