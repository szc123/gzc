...
<div class="mainbg">
	<div class="left fleft">
		...
		<div class="weizhi">当前位置：<a href="#">首页</a> &gt; 公证研讨</div>
		<!-- 公证研讨 -->
		<div class="gzdt">
			<ul class="gzdtlist">
				<li class="name"><a href="#">完善规章制度 提高管理水平</a></li><li class="time">2010-12-31</li>
				<li class="name"><a href="#">“上海公证杯”全国公证行业素质拓展挑战赛.</a></li><li class="time">2010-12-31</li>
				<li class="name"><a href="#">司法部律师公证工作指导司何敏副司长、业务指导处处长黄�莅临我处检查指导公证工作</a></li><li class="time">2010-12-31</li>
				<li class="name"><a href="#">香港中国委托公证人协会访问团一行访问我处</a></li><li class="time">2010-12-31</li>
				<li class="name"><a href="#">湖北省武汉市楚信公证处网站正式开通！</a></li><li class="time">2010-12-31</li>
				<li class="name"><a href="#">完善规章制度 提高管理水平</a></li><li class="time">2010-12-31</li>
				<li class="name"><a href="#">“上海公证杯”全国公证行业素质拓展挑战赛.</a></li><li class="time">2010-12-31</li>
				<li class="name"><a href="#">司法部律师公证工作指导司何敏副司长、业务指导处处长黄�莅临我处检查指导公证工作</a></li><li class="time">2010-12-31</li>
				<li class="name"><a href="#">香港中国委托公证人协会访问团一行访问我处</a></li><li class="time">2010-12-31</li>
