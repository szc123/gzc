...
{    //远程自动获取
	...
	//sContent=request.getParameter("eWebEditor_UploadText"); //此处修改下边语句，解决中文乱麻 www.ITstudy.cn
	sContent=new String(request.getParameter("eWebEditor_UploadText").getBytes("iso-8859-1"));
    if(sContent==null)
	{
		sContent="www.chinaade.com";
	}
	else
		//sContent=request.getParameter("eWebEditor_UploadText"); //此处修改下边语句，解决中文乱麻 www.ITstudy.cn
		sContent=new String(request.getParameter("eWebEditor_UploadText").getBytes("iso-8859-1"));
   ...
   //设置上传文件大小
	...
	// Retreive the current file
		...
		if (!myFile.isMissing()) {
			...
			sPathFileName="/upload/fy/"+sSaveFileName;
