...
<div class="mainbg">
	<div class="left fleft">
		...
		<div class="weizhi">当前位置：<a href="#">首页</a> &gt; <a href="#">网上咨询</a> &gt; 访客留言</div>
		<!-- 网上咨询 -->
		<div class="wszx">
			<p class="button2"><button>添加留言</button> &nbsp;<button>查看留言</button></p>
			<div class="liuyan">
				<p class="lyr"><b>楚信公证处访客留言标题</b> <span>留言人：姓名  时间12:22:12  ID：2686</span></p>
			    <p class="lyshow">访客留言内容显示发哈搜房和发生看了和热爱看了符合倒，萨华盛顿拉开发和规范书达离开航空萨芬很快了骄傲返回。氨基酸法规和咖啡牙缝里好看啊发生的浪费，发打算分开了阿弗莱克沙发看了范德萨。
				</p>
				<p class="hfly">
				你好，感谢的对楚信公证处工作的关注，您提出的问题我们会及时与您联系，给出答案。谢谢支持！
				</p>
				<p class="hflyr">回复人：姓名  时间15:22:12  ID：2600</p>
			</div>
			<div class="liuyan">
				<p class="lyr"><b>楚信公证处访客留言标题</b> <span>留言人：姓名  时间12:22:12  ID：2686</span></p>
			    <p class="lyshow">访客留言内容显示发哈搜房和发生看了和热爱看了符合倒，萨华盛顿拉开发和规范书达离开航空萨芬很快了骄傲返回。氨基酸法规和咖啡牙缝里好看啊发生的浪费，发打算分开了阿弗莱克沙发看了范德萨。
